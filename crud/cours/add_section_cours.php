...
$id_cours=isset($_GET['id_cours']) ? $_GET['id_cours'] : die('ERROR: cours ID not found!');
...
if($_POST){
    ...
    try{
        ...
        // insert query
        $query = "INSERT INTO section_cours SET titre=:titre, contenu=:contenu, id_cours=:id_cours";
    ...
    // show error
        ...
        die('ERROR PDO: ' . $exception->getMessage());
    }
}
?> 
   ...
   <section class="page-section">
            <div class="container">
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?id_cours={$id_cours}");?>"
 method="post">
                    <div class="row align-items-stretch mb-5">
                        <div class="col-md-6">
                            <div class="form-group">
                                <input class="form-control" id="titre" type="text" name="titre" placeholder="Titre du cours *" required="required" data-validation-required-message="Merci d'ajouter le titre." />
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-group-textarea mb-md-0">
                                <textarea class="form-control" id="contenu" placeholder="Description du contenu *" required="required" name="contenu" data-validation-required-message="Merci de créer du contenu pour votre cours."></textarea>
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
                    </div>

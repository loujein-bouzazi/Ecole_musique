...
if($_POST){
    ...
    try{
        ...
        // insert query
        $query = "INSERT INTO cours SET titre=:titre, description=:description, niveau=:niveau, id_enseignant=:id_enseignant";
   ...
   <section class="page-section">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Ajouter un cours</h2>
                    ...
                    <div class="row align-items-stretch mb-5">
                        <div class="col-md-6">
                            <div class="form-group">
                                <input class="form-control" id="titre" type="text" name="titre" placeholder="Titre du cours *" required="required" data-validation-required-message="Merci d'ajouter le nom du cours." />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="form-group">
                                <input class="form-control" name="niveau" min="1" id="niveau" type="number" placeholder="Niveau de difficulté *" required="required" data-validation-required-message="Merci de choisir le niveau de difficulté." />
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-group-textarea mb-md-0">
                                <textarea class="form-control" id="description" placeholder="Description du contenu *" required="required" name="description" data-validation-required-message="Merci de créer une desciprtion pour votre cours."></textarea>
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
                    </div>
